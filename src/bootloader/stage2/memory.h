...
typedef struct MEMORY_Map {
	MEMORY_E820Entry far* Entries;	// Ponteiro far para o buffer onde as entradas E820 são armazenadas.
...
typedef struct MEMORY_BootInfo {
	...
	MEMORY_Map MemoryMap;				// Visão do mapa de memória carregado pelo stage2.
	MEMORY_Allocator KernelAllocator;	// Alocador simples para o kernel.
...
/** Flags indicando quais campos do MEMORY_BootInfo são válidos. 
